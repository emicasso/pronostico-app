  ...
  return (
    <div className="container p-4 flex items-center justify-around shadow-lg rounded-lg bg-white h-1/3 mb-auto">
      <div className="my-auto">
        <p className="font-bold text-5xl text-teal-900 mb-2">15&deg;C</p>
        <p className="text-4xl text-gray-800 tracking-widest">
          Nublado
          {/* <img src={weather_icon} className="w-1/4 inline" /> */}
        </p>
        <p className="text-gray-400 text-xs uppercase tracking-widest">Nubosidad Variable</p>
        <p className="tracking-wider">Jueves 26 de Mayo</p>
      </div>
